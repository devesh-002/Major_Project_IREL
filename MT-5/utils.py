...
#from multilingual_rouge_scoring import rouge_scorer, scoring
...
"""
MultiLevel
python3 pipeline.py  --model_name_or_path "google/mt5-base"  --data_dir "./Hindi"  --output_dir "./Output"  --lr_scheduler_type="linear"  --learning_rate=5e-4  --warmup_steps 100  --weight_decay 0.01   --per_device_train_batch_size=2  --gradient_accumulation_steps=16   --num_train_epochs=10  --save_steps 100  --predict_with_generate  --evaluation_strategy "epoch"  --logging_first_step  --adafactor  --label_smoothing_factor 0.1  --do_train  --do_eval
Individual
python pipeline.py --model_name_or_path "google/mt5-base" --data_dir "XL_Input/individual/hin" --output_dir "Output/" --lr_scheduler_type="linear" --learning_rate=5e-4 --warmup_steps 100 --weight_decay 0.01 \--per_device_train_batch_size=2 --gradient_accumulation_steps=16  --num_train_epochs=10 --save_steps 100 --predict_with_generate --evaluation_strategy "epoch" --logging_first_step --adafactor --label_smoothing_factor 0.1 --do_train --do_eval
"""
